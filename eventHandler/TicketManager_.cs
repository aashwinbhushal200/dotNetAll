namespace solution {
    ...
    public class TicketManager {
        ...
        protected virtual void OnLogin(LoginEventArgs e)
        {
            ...
            //EventHandler<LoginEventArgs>? loginEvent = LoginEvent;
        ...
        //Implement Login and use OnLogin to raise event
        public void Login(string username, string password)
        {
            string adminUsername = "pluralsight";
            string adminPassword = "pspassword";

            bool loginSuccessful = username == adminUsername && password == adminPassword;

            if (loginSuccessful) {
                IsLoggedIn = true;
            }

            OnLogin(new LoginEventArgs { IsSuccessful = loginSuccessful });
        }
